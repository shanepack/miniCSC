...
//
// This tutorial assumes you are using the MiniCSC.cc plugin found here:
// https://github.com/shanepack/miniCSC/blob/main/plugins/MiniCSC.cc
// For information on using this plugin see: https://twiki.cern.ch/twiki/bin/view/CMS/DAQminiCSC
//
// After running the MiniCSC.cc plugin, you need to download the output root file to the same directory as this script.
// You can either copy the file to `/eos/user/<first initial>/<lxplus username>` which makes it show up in your CERNBox.
// Or you can mount your lxplus workspace using sshfs or scp.
